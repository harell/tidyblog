...
* Data + Data Access Object = Data Source
* Data Source + Analytic Module = Analytic App

## Examples

* Data Source: A combination of one or more databases, APIs, flat files etc.
* Analytic App: Dashboard, report, predictive modelling, etc.
-->
