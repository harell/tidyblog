...
### The developers encounter real-world impediments 

```{r 1st-world-problems} 
knitr::include_graphics('https://i.imgur.com/TAcOHZO.png')
```

Programmers encounter many 1^st^ world problems during the development process;
Unavailable database is one of them. A slow database is another.
