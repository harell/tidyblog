...
### Moving from ideation to implementation, programmers encounter real-world impediments 
...
A tidy data [@wickham2016r, ch. 12] table follows a consistent tabular format
...
app*. The suggested system design:

(1) Divides those parts into modules; 
